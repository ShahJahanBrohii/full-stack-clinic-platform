...
export default function Login() {
        ...
        <div className="w-full max-w-md border border-slate-200 bg-white shadow-sm p-6 flex flex-col gap-4 rounded-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-2 mt-1">
            <button
              ...
              className="flex-1 px-4 py-3 bg-[#0EA5E9] text-[#0F172A] font-bold text-xs tracking-widest uppercase hover:bg-white transition-colors duration-200"
            >
              Continue
            </button>
            <button
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <div className="hidden lg:flex flex-col justify-start w-1/2 bg-[#0F172A] border-r border-primary/30 p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 mt-16">
          ...
          >
            WELCOME
            <br />
            <span className="text-[#0EA5E9]">BACK,</span>
            <br />
            CHAMPION.
          </h2>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 sm:px-8 py-12">
        ...
        {/* Mobile logo */}
        <NavLink to="/" className="flex lg:hidden items-center gap-3 mb-10 group" aria-label="Ali's Clinic — Home">
          <div className="w-8 h-8 flex items-center justify-center bg-[#0EA5E9]">
          ...
          <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between">
                ...
                <NavLink
                  to="/reset-password"
                  className="text-xs text-slate-500 hover:text-[#F97316] transition-colors duration-150"
                >
                  Forgot password?
                </NavLink>
              </div>
            ...
            <button
              ...
              disabled={loading}
              aria-busy={loading}
              className="mt-2 flex items-center justify-center gap-3 w-full py-4 bg-[#0EA5E9] text-[#0F172A] font-bold text-sm tracking-widest uppercase hover:bg-white transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
                <>
